...
footnotes = [
    ...
    (('About a ringer (7)', 6, [6]), ([7], [6], 'About a ringer.')),
    (('About a ringer 7', 6, [6]), ([7], [6], 'About a ringer.')),
    (('An achievement for 7', 6, [6]), ([7], [6], 'An achievement.')),
    ...
    (('Achievements for 7, 9th', 6, [6]), ([7, 9], [6], 'Achievements.')),
    ...
    (('First quarter as conductor for 3', 6, [3]), ([3], [3], 'First quarter as conductor.')),
