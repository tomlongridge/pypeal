...
footnotes = [
    ...
    (('About a ringer: 7th', 6, [6]), ([7], 'About a ringer.')),
    (('About a ringer: seventh', 6, [6]), ([7], 'About a ringer.')),
    (('About another ringer - 1', 6, [6]), ([1], 'About another ringer.')),
    (('About another ringer - treble', 6, [6]), ([1], 'About another ringer.')),
    (('About two ringers: 7, 9th', 6, [6]), ([7, 9], 'About two ringers.')),
    (('About three ringers: 7th,9&11', 6, [6]), ([7, 9, 11], 'About three ringers.')),
    (('About three ringers: 1, 9 and tenor', 6, [6]), ([1, 6, 9], 'About three ringers.')),
    (('9: About a ringer', 6, [6]), ([9], 'About a ringer.')),
    (('9th: About a ringer', 6, [6]), ([9], 'About a ringer.')),
    (('4-About another ringer', 6, [6]), ([4], 'About another ringer.')),
    (('4th-About another ringer', 6, [6]), ([4], 'About another ringer.')),
    (('treble, 2: About two ringers', 6, [6]), ([1, 2], 'About two ringers.')),
    ((' 3,4and5th: About three ringers', 6, [6]), ([3, 4, 5], 'About three ringers.')),
    (('5, tenor & 3: About three ringers', 6, [6]), ([3, 5, 6], 'About three ringers.')),
