CREATE TABLE @db_name.`reports` (
    ...
    CONSTRAINT `fk_reports_association` FOREIGN KEY (`association_id`) REFERENCES `associations` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
);
